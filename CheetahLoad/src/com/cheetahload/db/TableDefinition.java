...
public final class TableDefinition {
	public static final String TIMER = "create table timer (script_name varchar(20), vuser_name varchar(20),duration int)";
	public static final String TRANSACTION = "create table transaction (script_name varchar(20), vuser_name varchar(20), transaction_name varchar(20), duration int)";
